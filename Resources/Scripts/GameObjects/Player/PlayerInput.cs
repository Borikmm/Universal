...
public class PlayerInput : MonoBehaviour
{
    ...
    {
        _selectingService = new SelectingService(selectingsquarePrefub);
    }
    ...
    private GameObject CheckTap()
    {
        ...
        {
            if (hit.gameObject.layer == 6 &&  hit.gameObject.GetComponent<BaseEntity>().Fraction == ClassEntity.Player)
            {
